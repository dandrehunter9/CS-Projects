...
//************************************************************
//
//	$Source: /cvsroot/ATM/implementation/event/event.Event.java,v $
//
...
public class Event
{
	...
	/** 
	  * Provide a complete displayable version of the event.Event.
