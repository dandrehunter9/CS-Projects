...
public class ArticleView extends View {
    ...
    //----------------------------------------------------------
    public ArticleView(IModel book) {
        super(book, "ArticleView");
        ...
        myModel.subscribe("ArticleSavedMessage", this);
    }
    ...
    private VBox createFormContent() {
        ...
        Text prompt = new Text("ARTICLE INFORMATION");
        ...
        ArticleView.this.description = new TextField();
        ArticleView.this.description.setEditable(true);
        grid.add(ArticleView.this.description, 1, 1);
        ...
        ArticleView.this.barcodePrefix = new TextField();
        ArticleView.this.barcodePrefix.setEditable(true);
        grid.add(ArticleView.this.barcodePrefix, 1, 2);
        ...
        ArticleView.this.alphaCode = new TextField();
        ArticleView.this.alphaCode.setEditable(true);
        grid.add(ArticleView.this.alphaCode, 1, 3);
    ...
    private void ProcessAction(ActionEvent actionEvent) {
        ...
        if ((descriptionEntered == null) || (descriptionEntered.length() == 0)) {
            ...
            myModel.stateChangeRequest("NewArticleData", props);
        }
    }
    ...
    public void populateFields() {
        ArticleView.this.description.setText((String) myModel.getState("Description"));
        ArticleView.this.barcodePrefix.setText((String) myModel.getState("Barcode Prefix"));
        ArticleView.this.alphaCode.setText((String) myModel.getState("Alpha Code"));
    }
    ...
    public void updateState(String key, Object value) {
        clearErrorMessage();
        if (key.equals("ArticleSavedMessage") == true)
        {
