...
public class ModifyColorView extends View {
    ...
    public ModifyColorView(IModel model) {
    ...
    private VBox createFormContent() {
        ...
        description.setText((String)color.getState("Description"));
        barcodePrefix.setText((String) color.getState("Barcode_Prefix"));
        alphaCode.setText((String) color.getState("Alpha_Code"));
        ...
        submitButton.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent e) {
                ...
                if(prefix[0] == '1' || prefix[0] == '0') {
                    ...
                    myModel.stateChangeRequest("UpdateColor", p);
                }else{
