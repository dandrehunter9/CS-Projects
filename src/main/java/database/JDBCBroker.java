...
public class JDBCBroker
{
	...
	protected JDBCBroker()
		...
		props = new PropertyFile("C:\\Users\\dandr\\Documents\\class\\CSC429\\src\\main\\java\\database\\dbConfig.ini");
		if (props != null)
		{
			...
			if(theDBConnection == null)
			{
				if ((dbName != null) & (username != null) && (password != null))
				{
					...
					catch(SQLException exc)
					{
						...
						//new event.Event(event.Event.getLeafLevelClassName(this), "getConnection", "Could not connect to database", event.Event.ERROR);
					}     
				}
			}   
		}	
